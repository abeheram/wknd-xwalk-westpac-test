...
require(['https://main--wknd-xwalk-westpac-test--abeheram.aem.live/scripts/lib-franklin.js', 'https://main--wknd-xwalk-westpac-test--abeheram.aem.live/scripts/analytics/lib-analytics.js'], function (libFranklin, analyticsLib) {
    "use strict";
const {
  sampleRUM,
  getAllMetadata,
