...
require.config({
  paths: {
    franklinModule:
      "https://main--wknd-xwalk-westpac-test--abeheram.aem.live/scripts/lib-franklin2.js",
    analyticsModule:
      "https://main--wknd-xwalk-westpac-test--abeheram.aem.live/scripts/analytics/lib-analytics2.js",
  },
}),
  define([], function () {
    "use strict";
    function main() {
      return require([
        "franklinModule",
        "analyticsModule",
      ], function (libFranklin, analyticsLib) {
        ...
        async function loadDemoConfig() {
          ...
          if (
            ...
            if (resp.status === 200) {
              ...
              console.log(
                "[WDP] Demo config blocks loaded:",
                Object.keys(demoConfig.blocks).length
              );
        ...
        async function loadLazy(doc) {
          ...
          addFavIcon(
            `${
              window.wknd.demoConfig.demoBase || window.hlx.codeBasePath
            }/favicon.png`
          );
          sampleRUM("lazy");
