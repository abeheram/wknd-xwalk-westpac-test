  ...
  // Fetch data from endpoint and render UI
    ...
    function renderPromotions() {
      ...
      grid.innerHTML = promotions.map(p => `
        <div class="offer-card ${p.defaultStylef} ${p.defaultBackgroundColour}">
          <div class="offer-card-content">
            <img src="${p.image._dmS7Url}" alt="${p.heading}" style="width:100%;height:auto;border-radius:4px;margin-bottom:10px;" />
